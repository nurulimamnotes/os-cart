...
var nicEditorConfig = bkClass.extend({
	...
	iconsPath : '../os-media/js/nicEditorIcons.gif',
			...
			if(type == 'title') {
				...
				switch(type) {
					...
					case 'select':
						...
						break;
					case 'content':
						this.inputs[itm] = new bkElement('textarea').setAttributes({id : itm}).setStyle({border : '0 solid #ccc', 'float' : 'left'}).setStyle(field.style).appendTo(contain);
