      ...
      <div class="col-lg-9 col-md-9 col-sm-8 col-xs-12 menu-col-2"> 
        <div class="menu-links hidden-xs">
          <ul class="nav nav-pills nav-justified">
            ...
            <li class="dropdown"> <a href="';urltoko(); echo '?halaman=keranjang.html"> <i class="fa fa-shopping-cart fa-fw"></i> <span class="hidden-sm"> 5 item | Rp. 75.000</span></a></li>
          </ul>
        </div>
